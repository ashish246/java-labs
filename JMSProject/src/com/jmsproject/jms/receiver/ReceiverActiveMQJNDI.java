...
public class ReceiverActiveMQJNDI {
	
	private static final Logger LOG = LoggerFactory.getLogger(ReceiverActiveMQJNDI.class);
	
    public ReceiverActiveMQJNDI() {
    ...
    public static void main(String[] args) {
        ReceiverActiveMQJNDI receiver = new ReceiverActiveMQJNDI();
