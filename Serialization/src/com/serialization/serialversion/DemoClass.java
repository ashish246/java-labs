package com.serialization.serialversion;
...
/**
 * Static & transient variables will not be serialized.
 * 
 * Static final will be serialized.
 * 
...
public class DemoClass implements java.io.Serializable {
	...
	private static final long serialVersionUID = 4L; // Default serial version
														// uid
	private static final String fileName = "DemoClassBytes.ser"; // Any random
																	// name
	...
	private Thread threadClass = new Thread();
	...
	public String toString() {
		return "DemoClass: final static fileName=" + fileName
				...
				+ ", non-serializable instance field threadClass:="
				+ threadClass;
	}
}
