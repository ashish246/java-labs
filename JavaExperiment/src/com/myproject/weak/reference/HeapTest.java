package com.myproject.weak.reference;
...
public class HeapTest {
	...
	public static void main(String[] args) {
		 ...
		 * that object in WeakHashMap can be type casted successfully to a weak
		 * reference.
		 */
		 ...
		 * entries in referenceQ. So mapp.entrySet will find entries Entryin the
		 * reference Q and , it de-allocate the entry from the WeakHashMap, and
		 * byte[] will * garbage collected.
		 */
