...
/**
 * Java program to demonstrate How to use EnumMap in Java If Key Object is Enum
 * than it’s best to EnumMap to get better performance. Most of IDE like
 * Netbeans and Eclipse suggest you to use EnumMap instead of HashMap or any
 * other Map implementation when key object is Enum.
 * 
